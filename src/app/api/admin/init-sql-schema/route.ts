...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    await client.query('CREATE INDEX IF NOT EXISTS idx_api_org ON api_keys(organization_id)');
    await client.query('CREATE INDEX IF NOT EXISTS idx_api_active ON api_keys(is_active)');
