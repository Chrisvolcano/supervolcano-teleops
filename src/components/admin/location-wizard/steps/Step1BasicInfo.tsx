...
export default function Step1BasicInfo({
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <div className="w-14 h-14 bg-blue-100 dark:bg-blue-900/20 rounded-full flex items-center justify-center mb-4">
          <Home size={28} className="text-blue-600 dark:text-blue-400" />
        </div>
        <h3 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Location Details</h3>
      ...
      <div className="space-y-6">
        {/* Location Name */}
        <div>
          <label htmlFor="location-name" className="block text-sm font-semibold mb-2 text-gray-900 dark:text-white">
          ...
          />
          <p id="name-hint" className="mt-1.5 text-sm text-gray-500 dark:text-gray-400">
        ...
        {/* Address */}
        <div>
          <label htmlFor="location-address" className="block text-sm font-semibold mb-2 text-gray-900 dark:text-white">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              required
              aria-required="true"
              aria-describedby="address-hint"
            />
          </div>
          <p id="address-hint" className="mt-1.5 text-sm text-gray-500 dark:text-gray-400">
