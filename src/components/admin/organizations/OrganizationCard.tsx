  ...
  return (
    <div className="bg-white dark:bg-[#141414] rounded-lg border border-gray-200 dark:border-[#1f1f1f] p-6 hover:shadow-md dark:hover:shadow-none transition-shadow">
      ...
      {organization.billingStatus && (
        <div className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-green-500/20 text-green-800 dark:text-green-400">
          {organization.billingStatus}
        </div>
      )}
    </div>
